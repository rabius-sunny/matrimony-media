    ...
    <div className='aboutus'>
      <Head>
        ...
        <meta
          ...
          content='Description text for matrimony media. This is description for meta.'
        />
        <meta
      ...
      <div className='container2 minHeight'>
        ...
        <div className='aboutus__text'>
          <p>
            সকল প্রশংসা মহান আল্লাহর নামে যিনি আমাদেরকে আশরাফুল মাখলুকাত হিসেবে
            সৃষ্টি করে এ বিশ্ব ধরায় প্রেরণ করেছেন। দুরুদ ও সালাম জানাই বিশ্ব
            মানবতার মহান দূত, যিনি আল্লাহর পক্ষ থেকে পরিপূর্ণ জীবন ব্যবস্থা
            হিসেবে অবতীর্ণ ইসলামের শেষ এবং চুরান্ত রাসূল হিসেবে এ দুনিয়ায় আগমন
            করেছেন।
          </p>
          <p>
            কুরআন-হাদীসের ভাষ্য অনুযায়ী মানব প্রজন্ম রক্ষার সাথে সাথে চরিত্র
            রক্ষা ও মনের প্রশান্তিলাভও বিবাহের অন্যতম প্রধান উদ্দেশ্য। যে কোনো
            পক্ষে দ্বীনদারীর অভাব থাকলে এসব উদ্দেশ্যের সবটাই ঝুঁকিতে পড়ে যায়।
          </p>
          <p>
            আমরা গভীর দুঃখের সাথে লক্ষ্য করছি যে, বর্তমান সমাজে অনৈতিক সম্পর্ক,
            ব্যাভিচার, পরকীয়া ইত্যাদি সহজলভ্য ও মহামারীর ন্যায় ছড়িয়ে গিয়েছে
            কিন্তু পরিবার গঠনের সবচেয়ে গুরুত্বপূর্ণ মাধ্যম বিবাহ করা অত্যন্ত
            কঠিন হয়ে দাড়িয়েছে। ফলশ্রুতিতে সামাজিক অবক্ষয়ে সমাজ ভারাক্রান্ত।
          </p>
          <p>
            আমরা আরো লক্ষ্য করেছি যে, যেসব ভাই-বোন পরিবারে দ্বীনি পরিবেশ না থাকা
            সত্ত্বেও কষ্ট করে দ্বীনের উপর অবিচল থাকার চেষ্টা করেন, তারা বিবাহের
            সময় প্রতিকূল পরিস্থিতিতে পড়েন। দেখা যায় যে, পরিবার পাত্র-পাত্রী
            নির্বাচনে দ্বীন ব্যতিত সব বিষয়কেই যথাযথ গুরুত্ব প্রদান করে, যেখানে
            শরিয়তে দ্বীন ব্যতিত সবই গৌণ।
          </p>
          <p>
