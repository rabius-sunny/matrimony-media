      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          ...
          <Fade right when={errors.ex_year ? true : false}>
            {errors.ex_year && (
              <p className='text-red-500 py-2 pl-2'>{errors.ex_year.message}</p>
            )}
          </Fade>
        </fieldset>
        ...
        <fieldset
          className={`my-6 rounded-md border-2 ${
            errors.ex_marrital_condition ? 'border-red-500' : 'border-blue-300'
          } p-4`}
        >
          <legend
            className={`ml-4 font-bold ${
        ...
        <fieldset
          className={`my-6 rounded-md border-2 ${
            errors.ex_financial_condition ? 'border-red-500' : 'border-blue-300'
          } p-4`}
        >
          <legend
            className={`ml-4 font-bold ${
