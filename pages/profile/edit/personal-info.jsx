      ...
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            >
              ...
              <div className='ppl-2 pt-4 text-blue-400'>
                এভাবে উত্তর দিতে পারেনঃ- "সাদা পাঞ্জবী সাথে সাদা টুপি" বা "জিন্স
                প্যান্ট সাথে শার্ট"
              </div>
            </fieldset>
          </div>
        ...
        {type && type === 'পাত্রীর বায়োডাটা' && (
          ...
          >
            ...
            <Fade right when={errors.dress ? true : false}>
              {errors.dress && (
                <p className='text-red-500 py-2 pl-2'>{errors.dress.message}</p>
              )}
            </Fade>
            <p className='pl-2 pt-4 text-blue-400'>
              উত্তর যেভাবে দিতে পারেনঃ- "কালো বোরকা ও হিজাব পরি কিন্ত নিকাব পরি
              না" বা " কালো বোরকা ও নিকাব পরি কিন্ত হাত-পা মোজা পরি না"। এভাবে
              নিজের মত করে আপনার পোষাকের বিবরণ দিবেন। যেন পাঠক আপনার পর্দার
              ব্যাপারে নূন্যতম ধারণা করতে পারেন।
            </p>
          </fieldset>
        )}
        ...
        >
          ...
          <input
            ...
            className={`w-full rounded ${
              ...
              errors.salat ? 'focus:outline-red-500' : 'focus:outline-blue-500'
            }`}
          />
        ...
        >
          ...
          <input
            ...
            className={`w-full rounded ${
              ...
              errors.mazhab ? 'focus:outline-red-500' : 'focus:outline-blue-500'
            }`}
          />
          <Fade right when={errors.mazhab ? true : false}>
            {errors.mazhab && (
              <p className='text-red-500 py-2 pl-2'>{errors.mazhab.message}</p>
            )}
          </Fade>
        </fieldset>
        ...
        >
          ...
          <Fade right when={errors.disease ? true : false}>
            {errors.disease && (
              <p className='text-red-500 py-2 pl-2'>{errors.disease.message}</p>
            )}
          </Fade>
        </fieldset>
        ...
        >
          ...
          <p className='pl-2 pt-4 text-blue-400'>
            নিজের পছন্দ-অপছন্দ, শখ-ইচ্ছা, দ্বীনী-দুনিয়াবী ইত্যাদি বিষয় বিস্তারিত
            লিখতে হবে। কারণ এই লেখা পড়ে পাঠক আপনার সম্পর্কে সাধারণ ধারণা লাভ
            করবে।
          </p>
        </fieldset>
        <input
