      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          ...
          <p className='pl-2 pt-4 text-blue-400'>
            পিতার পূর্ণ নাম লিখবেন, নাম নেয়া হচ্ছে শুধু ভেরিফিকেশনের জন্য। আপনার
            পিতার নাম পাবলিশ করা হবে না এবং কর্তৃপক্ষ ছাড়া আর কেউ দেখতে পারবে
            না।
          </p>
        </fieldset>
        ...
        >
          ...
          <p className='pl-2 pt-4 text-blue-400'>
            মাতার পূর্ণ নাম লিখবেন, নাম নেয়া হচ্ছে শুধু ভেরিফিকেশনের জন্য। আপনার
            মাতার নাম পাবলিশ করা হবে না এবং কর্তৃপক্ষ ছাড়া আর কেউ দেখতে পারবে
            না।
          </p>
        </fieldset>
        ...
        >
          ...
          <p className='pl-2 pt-4 text-blue-400'>
            মৃত হলে প্রথমে (মৃত) লেখার পর পেশা লিখবেন। যেমনঃ (মৃত) গৃহিণী ছিলেন।
          </p>
        </fieldset>
        ...
        {newBrothers.indexOf(brothers) > 0 && (
          <fieldset
            className={`my-6 rounded-md border-2 ${
              errors.brother_info ? 'border-red-500' : 'border-blue-300'
            } p-4`}
          >
            <legend
              className={`ml-4 font-bold ${
                errors.brother_info ? 'text-red-500' : 'text-blue-500'
              }`}
            >
              ভাইদের সম্পর্কে তথ্য
            </legend>
            <input
              {...register('brother_info')}
              className={`w-full rounded ${
                errors.brother_info ? 'bg-red-100' : 'bg-blue-100'
              } px-4 py-2 font-medium text-blue-400 shadow-md ${
                errors.brother_info
                  ? 'focus:outline-red-500'
                  : 'focus:outline-blue-500'
            ...
            />
            <p className='pl-2 pt-4 text-blue-400'>
              সকল ভাইদের শিক্ষাগত যোগ্যতা, বৈবাহিক অবস্থা, পেশা, বর্তমান অবস্থান
              লিখুন। একাধিক ভাই থাকলে কমা দিয়ে নিচের লাইনে এসে লিখবেন।
            </p>
          </fieldset>
        )}
        ...
        >
          ...
          <Fade right when={errors.sisters ? true : false}>
            {errors.sisters && (
              <p className='text-red-500 py-2 pl-2'>{errors.sisters.message}</p>
            )}
          </Fade>
        </fieldset>
