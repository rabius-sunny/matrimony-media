export default function Hometext() {
  return <>
    পাত্র-পাত্রী নির্বাচন খুব গুরুত্বপূর্ণ একটি বিষয়। যে মানুষটির সাথে সারা জীবন অতিবাহিত করতে হবে সেই মানুষটির চারিত্রিক ও নৈতিক বৈশিষ্ট্য তার জীবনসঙ্গীর উপর অনেক প্রভাব বিস্তার করে। <br /> <br />

    এ ব্যাপারে কয়েকটি হাদিস উল্লেখযোগ্য – <br /> <br />

    <p className="font-bold text-gray-500">
      ‘যার দ্বীনদারী ও চরিত্রে তোমরা সন্তুষ্ট, এমন কেউ বিবাহের প্রস্তাব দিলে তার সাথে তোমরা বিবাহ সম্পন্ন কর। তা না করলে পৃথিবীতে ফিৎনা দেখা দেবে ও ব্যাপক ফ্যাসাদ ছড়িয়ে পড়বে।’ (তিরমিযী: ১০৮৪)</p> <br />
