...
export default function SearchDropdownProfile({
  legend,
  data,
  required,
  selected,
  ...
  let filtered = data.filter(item => item.includes(search))
  return (
        ...
        <div className='relative mt-1'>
          ...
          >
            <Listbox.Options className='absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm'>
              <input
                type='text'
                className='w-full py-2 px-3 border-red-200 border-b-2 focus:outline-none'
